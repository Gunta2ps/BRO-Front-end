...
function Input({label, name, type, handleChange, value, error}) {
    return (
      <div className="bg-white pt-2 px-2 rounded-lg w-full">
          <div className="relative bg-inherit w-full">
              <input 
                ...
                className={`peer bg-transparent h-10 w-full rounded-lg text-black placeholder-transparent ring-2 px-2
                 ring-gray-300 focus:ring-[#16325B] focus:outline-none ${error ? 'ring-red-500' : ''}`} 
              />
