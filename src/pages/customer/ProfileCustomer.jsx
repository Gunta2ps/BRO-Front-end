...
function ProfileCustomer() {
    ...
    const handleEditButton = () =>{
        navigate('/customer/editprofile',{state:isUser})
    }
  ...
  return (
    <div className=" my-28 w-[98%] h-[98%] p-4 flex flex-col justify-start bg-white rounded-lg gap-4 ">
          ...
          <div className="flex flex-col gap-4 items-start mx-16">
            <p className="font-bold">Full Name : <span className="font-normal"> {isUser.firstName} {isUser.lastName} </span></p>
            <p className="font-bold">E-mail : <span className="font-normal"> {isUser.email} </span></p>
            <p className="font-bold">Phone Number : <span className="font-normal">{isUser.phone} </span></p>
            </div>
          </div>
